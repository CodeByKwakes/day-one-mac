...
Phase 5 later adopts the same launcher into chezmoi. Details are documented in
...
| [**5 — Dotfiles and shell**](01-required/05-dotfiles-and-shell.md) | Establish the chezmoi source, configure zsh and Starship, and adopt the early portable `day-one-mac` command. |
